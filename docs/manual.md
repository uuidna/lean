...
QPU worker. Version **0.3.1**. Live **[https://lean.uuidna.com](https://lean.uuidna.com)**. Paper: [Overview](/paper).
...
APA 7th: see [/author](/author). Parent: uuidna DOI [10.5281/zenodo.22256708](https://doi.org/10.5281/zenodo.22256708).

Licence CC BY-NC-ND 4.0. Full text [CC BY-NC-ND 4.0](https://creativecommons.org/licenses/by-nc-nd/4.0/).
